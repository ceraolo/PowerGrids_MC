...
annotation (
    Documentation(info = "<html><head></head><body>Simple test system with one slack node and one <a href=\"modelica://PowerGrids.Electrical.PowerFlow.ZLoad\"> ZLoad</a>.</body></html>"));
