...
equation
  ...
  annotation (
    ...
    Documentation(info = "<html><head></head><body><p style=\"font-size: 12px;\">Same behaviour as&nbsp;<a href=\"modelica://PowerGridsMC.Electrical.Test.TestTwoBusesTwoTransmLinesWithBreakersOneLoad\">TestTwoBusesTwoTransmLinesWithBreakersOneLoad</a>,&nbsp;but this time the breaker at portB of the line1 is opened in the time interval 1 to 10 seconds.</p><p style=\"font-size: 12px;\">When the breaker is open, the active power from line 2 is doubled, while the active power from the infiniteBus1 is reduced to the ones dissipated to the open line (i.e. Rseries+Rshunt).</p></body></html>"));
