...
model OneBusImpedanceOneLoad
  extends Loads.OneBusOneLoad(infiniteBus(
      R=0.3,
      X=1.5,
...
<p>This model is similar to <a href=\"modelica://PowerGridsMC.Electrical.Test.Loads.OneBusOneLoad\">OneBusOneLoad</a>, save for the internal impedance of the bus, which is set to R = 0.3 Ohm and X = 1.5 Ohm.</p>
