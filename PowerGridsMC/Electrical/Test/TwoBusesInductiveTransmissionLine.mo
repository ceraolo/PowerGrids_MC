...
model TwoBusesInductiveTransmissionLine
  ...
  PowerGridsMC.Electrical.Branches.LineConstantImpedance transmissionLine(R = 0, SNom = 1e+07, UNom = 10000, X = 1, portVariablesPhases = true, portVariablesPu = true) annotation (
