...
model TestExciterRectifierRegulationCharacteristicIEEE
  ...
  PowerGridsMC.Electrical.Controls.ExcitationSystems.BaseClasses.ExciterRectifierRegulationCharacteristicEquationsIEEE exciterRectifierRegulationCharacteristicIEEE annotation (
