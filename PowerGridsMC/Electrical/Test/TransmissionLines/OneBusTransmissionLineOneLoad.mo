...
equation
  ...
  annotation (
    ...
    Documentation(info = "<html><head></head><body><p>Same behaviour as <a href=\"modelica://PowerGridsMC.Electrical.Test.Loads.OneBusImpedanceOneLoad\">OneBusImpedanceOneLoad</a>, but this time the line impedance is not built-in the bus but rather represented explicitly with a Transmission Line. All quantities in the load are the same.
</body></html>"));
