...
model TwoBusesShuntTransmissionLine
  ...
  inner PowerGridsMC.Electrical.System systemPowerGrids annotation (
    Placement(transformation(origin = {48, 50}, extent = {{-10, -10}, {10, 10}})));
  PowerGridsMC.Electrical.Branches.LineConstantImpedance transmissionLine(B = 0.01, G = 0.01, R = 1e8, SNom = 1e+07, UNom = 10000, X = 0, portVariablesPhases = true, portVariablesPu = true) annotation (
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PowerGridsMC.Electrical.Buses.InfiniteBus infiniteBusB(SNom = 1e+07, UNom = 10000, portVariablesPu = true, theta = 0.523599) annotation (
    Placement(visible = true, transformation(origin = {40, 0}, extent = {{-10, 10}, {10, -10}}, rotation = -90)));
equation
