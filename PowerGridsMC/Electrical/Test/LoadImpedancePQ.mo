...
model LoadImpedancePQ "Test case for LoadImpedancePQ"
  ...
  PowerGridsMC.Electrical.Loads.LoadZeta load1(
    ...
    portVariablesPu=true) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  PowerGridsMC.Electrical.Loads.LoadZeta load2(
    PRef=8e+07 + (if time >= 1 then 1e7 else 0),
    PRefConst=4e+07,
    QRef=4e+7 + (if time >= 2 then 5e6 else 0),
    QRefConst=2e+07,
    SNom=1e+08,
    UNom=380000,
    URef=400000,
    ...
    portVariablesPu=true) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  PowerGridsMC.Electrical.Loads.LoadZetaInputs load3(
    SNom=5e+08,
    UNom=380000,
    URef=400000,
    portVariablesPhases=true,
