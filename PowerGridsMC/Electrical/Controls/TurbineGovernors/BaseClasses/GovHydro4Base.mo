within PowerGridsMC.Electrical.Controls.TurbineGovernors.BaseClasses;
partial model GovHydro4Base "Base class for Governors of hydraulic turbines"
  ...
  PowerGridsMC.Controls.DiscontinuousDeadBand deadbandDb1(uMax = db1 / 2) annotation (
  ...
  PowerGridsMC.Controls.FirstOrder lagTp(T = Tp, initType = Modelica.Blocks.Types.Init.SteadyState, y_start = 1) annotation (
  ...
  Modelica.Blocks.Nonlinear.Limiter limU(uMax=uo, uMin=uc) annotation (
      Placement(visible=true, transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  PowerGridsMC.Controls.IntegratorWithNonWindupLimiter limIntG(initType = Modelica.Blocks.Types.Init.SteadyState, yMax = gMax, yMin = gMin, yStart = 1) annotation (
  ...
  PowerGridsMC.Controls.DerivativeLag derlagTrRtemp(Td = Tr*rTemp, T1 = Tr, initType = Modelica.Blocks.Types.Init.SteadyState, yStart = 1) annotation (
  ...
  PowerGridsMC.Controls.DeadBand deadBandDb2(uMax = db2 / 2) annotation (
