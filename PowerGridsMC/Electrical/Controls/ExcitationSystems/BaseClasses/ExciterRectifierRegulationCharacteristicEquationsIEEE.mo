within PowerGridsMC.Electrical.Controls.ExcitationSystems.BaseClasses;
...
algorithm
  ...
  annotation (
    Icon(
      graphics={  Rectangle(origin = {0, -1},
      lineColor = {0, 0, 127}, fillColor = {255, 255, 255},
      fillPattern = FillPattern.Solid, extent = {{-100, 101}, {100, -99}}),
      Text(origin = {1, -1}, extent = {{-85, 49}, {85, -49}},
      textString = "Fex = f(In)")}),
