...
model SynchronousMachine4Windings "Synchronous machine with four windings - external parameters"
  ...
  parameter Types.Choices.TimeConstantsApproximation timeConstApprox =
    PowerGridsMC.Types.Choices.TimeConstantsApproximation.classicalDefinition
...
initial equation
  ...
  mrcPu = 0;
  annotation (
    Documentation(info = "<html><head></head><body><p>Same as <a href=\"modelica://PowerGridsMC.Electrical.Machines.SynchronousMachine4WindingsInternalParameters\">SynchronousMachine4WindingsInternalParameters</a>, but using external parameters such as transient and sub-transient time constants.</p>
