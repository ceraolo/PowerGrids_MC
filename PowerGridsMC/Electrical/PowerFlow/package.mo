...
package PowerFlow "Components for power flow calculations"
  ...
  annotation (
    Documentation(info = "<html><head></head><body><p>The components in this package can be used to build power flow models, together with the <a href=\"modelica://PowerGridsMC.Electrical.Branches.LineConstantImpedance\">LineConstantImpedance</a> models for transmission lines, <a href=\"modelica://PowerGridsMC.Electrical.Branches.TransformerFixedRatio\">TransformerFixedRatio</a> for transformers, and <a href=\"modelica://PowerGridsMC.Electrical.Buses.Bus\">Bus</a> for connection buses.</p>
