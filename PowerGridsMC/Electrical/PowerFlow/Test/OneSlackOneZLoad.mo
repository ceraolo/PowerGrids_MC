...
model OneSlackOneZLoad
  ...
  PowerGridsMC.Electrical.Loads.ZLoad load(
    PNom=2e+07,
    QNom=1e+07,
    SNom=3e+07,
...
annotation (
    Documentation(info=
          "<html><head></head><body>Simple test system with one slack node and one <a href=\"modelica://PowerGridsMC.Electrical.Loads.ZLoad\"> ZLoad</a>.</body></html>"));
