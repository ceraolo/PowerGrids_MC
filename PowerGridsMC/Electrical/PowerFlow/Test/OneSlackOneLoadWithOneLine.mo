...
annotation (
    Documentation(info = "<html><head></head><body>Simple test case with one slack bus and one PQ bus connected through a <a href=\"modelica://PowerGridsMC.Electrical.Branches.LineConstantImpedance\"> LineConstantImpedance </a> line. Adds a line between the slack and the PQ buses compared to <a href=\"modelica://PowerGridsMC.Electrical.PowerFlow.Test.OneSlackOneLoad\"> OneSlackOneLoad </a> test.</body></html>"));
