...
partial model OnePortAC3 "OnePortAC with different port position"
...
<p>This is the base class for all the components with an AC terminal. It contains a corresponding <span style=\"font-family: Courier New;\">PortAC</span> component to compute useful quantities for modelling and monitoring purposes. This version with final &quot;2&quot; has just a different position of the AC terminal.</p>
</html>"));
end OnePortAC3;
