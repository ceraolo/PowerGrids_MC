...
<p>LoadPQVoltageDependenceR, SynchronousMachine4WindingR, EquivalentGridR</p>
    ...
    model LoadChangeReg "Regulated verion"
      ...
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaInputs Grid2(UNom = 380000, SNom = 500000000, alpha = 2, beta = 2) annotation(
        Placement(transformation(extent = {{20, -22}, {40, -2}})));
      Modelica.Blocks.Sources.Step stepQ(height = 76e6, startTime = 1) annotation(
        Placement(transformation(extent = {{-16, -28}, {-8, -20}})));
      Modelica.Blocks.Sources.Step stepP(height = 500e6, startTime = 1) annotation(
        Placement(transformation(extent = {{-4, -20}, {4, -12}})));
    equation
      connect(GRIDL.terminal, NTHV.terminal) annotation(
        Line(points = {{50, -6}, {50, 10}, {20, 10}}));
      connect(GEN.terminal, NTLV.terminal) annotation(
      ...
      connect(stepP.y, Grid2.PRefIn) annotation(
        Line(points = {{4.4, -16}, {20, -16}}, color = {0, 0, 127}));
      connect(Grid2.terminal, NTHV.terminal) annotation(
        Line(points = {{30, -12}, {30, 10}, {20, 10}}, color = {0, 0, 0}));
      annotation(
        experiment(StopTime = 15, Interval = 0.004, Tolerance = 1e-06, __Dymola_Algorithm = "Dassl"),
        Documentation(info = "<html>
<p>Library PowerGridsMC was forked from https://github.com/PowerGrids/PowerGrids on 22 November 2024.</p>
...
<li>LoadChangeReg, containing the same transient as for the previous bullet, but here the generator contains power and excitation regulators.</li>
  ...
  package FourATbus "Network with four AT buses"
    model PowerFlowSI "Modello Paris SI con tensioni ai morsetti delle macchine unitarie"
      extends Modelica.Icons.Example;
      ...
      PowerGridsMC.Electrical.Loads.LoadPQW pq31(P(displayUnit = "MW") = 200000000, Q(displayUnit = "MVA") = 100000000, SNom(displayUnit = "MVA") = 100000000, UNom(displayUnit = "kV") = 129000) annotation(
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T31_33_1(R = 273/75e3*132^2/75, SNom(displayUnit = "MW") = 75000000, UNomA(displayUnit = "kV") = 13800, UNomB(displayUnit = "kV") = 132000, X = 0.0965*132^2/75, rFixed = 132/13.8, showPortData = true) annotation(
      ...
      PowerGridsMC.Electrical.PowerFlow.PVBusW sc22(P(displayUnit = "MW") = 0, SNom(displayUnit = "MVA") = 39000000, U(displayUnit = "kV") = 10000, UNom(displayUnit = "kV") = 10000) annotation(
        Placement(visible = true, transformation(origin = {106, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Teq31_3(R = 0.0948*230^2/160/30, SNom(displayUnit = "MW") = 160000000, UNomA(displayUnit = "kV") = 135000, UNomB(displayUnit = "kV") = 230000, X = 0.0948*230^2/160, rFixed = 230/135, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {-70, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadPQW pq41(P(displayUnit = "MW") = 100000000, Q(displayUnit = "MVA") = 50000000, SNom(displayUnit = "MVA") = 100000000, UNom(displayUnit = "kV") = 119000) annotation(
      ...
      PowerGridsMC.Examples.PFT.FourATbus.Line line annotation(
        Placement(visible = true, transformation(origin = {-60, -68.6957}, extent = {{-9.99999, -11.3043}, {9.99999, 8.69565}}, rotation = 0)));
      ...
      PowerGridsMC.Electrical.Loads.LoadPQW pq21(P(displayUnit = "MW") = 200000000, Q(displayUnit = "MVA") = 100000000, SNom(displayUnit = "MVA") = 100000000, UNom(displayUnit = "kV") = 127000) annotation(
        Placement(visible = true, transformation(origin = {36, 82}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T31_33_2(R = 273/75e3*132^2/75, SNom(displayUnit = "MW") = 75000000, UNomA(displayUnit = "kV") = 13800, UNomB(displayUnit = "kV") = 132000, X = 0.0965*132^2/75, rFixed = 132/13.8, showPortData = true) annotation(
      ...
      PowerGridsMC.Electrical.Buses.Bus bus33(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 13.8e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-95.5, 40.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus4(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {0.5, -33.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus31(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 135e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-99.5, -27.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus11(UNom(displayUnit = "kV") = 13800, SNom(displayUnit = "MVA") = 100000000) annotation(
        Placement(transformation(extent = {{-10, 82}, {10, 102}})));
      PowerGridsMC.Electrical.Buses.Bus bus22(SNom(displayUnit = "V.A") = 10E6, UNom(displayUnit = "V") = 10E3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {92.5, 28.5}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Buses.Bus bus1(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {0.5, 46.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus2(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
    ...
    equation
      ...
      connect(pq21.terminal, T21_i.terminalB) annotation(
        Line(points = {{36, 82}, {36, 72}, {56, 72}, {56, 60}}));
      connect(gen42x2.terminal, T42_iX2.terminalB) annotation(
        Line(points = {{56, -70}, {40, -70}}));
      ...
      connect(T41_iX2.terminalB, pq41.terminal) annotation(
        Line(points = {{0, -90}, {0, -104}}));
      connect(T31_33_2.terminalA, T31_33_1.terminalA) annotation(
        Line(points = {{-88, 24}, {-88, 30}, {-106, 30}, {-106, 22}}, color = {0, 0, 0}));
      connect(bus3.terminal, Teq31_3.terminalB) annotation(
        Line(points = {{-47.5, -11.5}, {-54, -11.5}, {-54, -12}, {-60, -12}}, color = {0, 0, 0}));
      connect(L3_2.terminalA, bus3.terminal) annotation(
        Line(points = {{-32, 10}, {-42, 10}, {-42, -11.5}, {-47.5, -11.5}}, color = {0, 0, 0}));
      ...
      connect(T4_iX2.terminalB, bus4.terminal) annotation(
        Line(points = {{0, -44}, {0.5, -44}, {0.5, -33.5}}, color = {0, 0, 0}));
      connect(L4_2.terminalB, bus4.terminal) annotation(
        Line(points = {{0, -18}, {0, -33.5}, {0.5, -33.5}}, color = {0, 0, 0}));
      connect(pq31.terminal, bus31.terminal) annotation(
        Line(points = {{-100, -42}, {-100, -27.5}, {-99.5, -27.5}}, color = {0, 0, 0}));
      connect(bus31.terminal, Teq31_3.terminalA) annotation(
        Line(points = {{-99.5, -27.5}, {-99.5, -12}, {-80, -12}}, color = {0, 0, 0}));
      connect(T22_i.terminalB, bus22.terminal) annotation(
        Line(points = {{84, 28}, {90, 28}, {90, 28.5}, {92.5, 28.5}}, color = {0, 0, 0}));
      connect(bus22.terminal, sc22.terminal) annotation(
        Line(points = {{92.5, 28.5}, {92.5, 28}, {106, 28}}, color = {0, 0, 0}));
      connect(T1_11_1.terminalA, T1_11_2.terminalA) annotation(
        Line(points = {{-10, 82}, {-10, 86}, {10, 86}, {10, 82}}, color = {0, 0, 0}));
      connect(gen11x2.terminal, bus11.terminal) annotation(
        Line(points = {{0, 108}, {0, 92}}, color = {0, 0, 0}));
      connect(bus11.terminal, T1_11_2.terminalA) annotation(
        Line(points = {{0, 92}, {0, 86}, {10, 86}, {10, 82}}, color = {0, 0, 0}));
      connect(T1_11_1.terminalB, T1_11_2.terminalB) annotation(
        Line(points = {{-10, 62}, {-10, 56}, {10, 56}, {10, 62}}, color = {0, 0, 0}));
      connect(bus1.terminal, T1_11_2.terminalB) annotation(
        Line(points = {{0.5, 46.5}, {0.5, 52}, {0, 52}, {0, 56}, {10, 56}, {10, 62}}, color = {0, 0, 0}));
      connect(L2_1.terminalA, bus1.terminal) annotation(
        Line(points = {{0, 38}, {0.5, 38}, {0.5, 46.5}}, color = {0, 0, 0}));
      connect(bus2.terminal, L2_1.terminalB) annotation(
        Line(points = {{20.5, 8.5}, {0, 8.5}, {0, 18}}, color = {0, 0, 0}));
...
<p>Names of buses with a two digit numerical code are inteded as submodels. For instance bus31, bus32, bus33 are intended as submodels of bus3: this because bus3.1, bus3.2, bus3.3 would have not been legal Modelica instance names.</p>
    ...
    model PowerFlowPU
      ...
      PowerGridsMC.Electrical.PowerFlow.PVBusW pv33(P(displayUnit = "W") = -1, SNom(displayUnit = "V.A") = 1, U(displayUnit = "V") = 1.04, UNom(displayUnit = "V") = 1, portVariablesPhases = true) annotation(
        Placement(visible = true, transformation(origin = {-106, 56}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadPQW pq31(P(displayUnit = "W") = 2, Q(displayUnit = "var") = 1, SNom(displayUnit = "V.A") = 1, UNom(displayUnit = "V") = 1, showPortData = true) annotation(
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T31_33x2(SNom(displayUnit = "W") = 1, UNomA(displayUnit = "V") = 1, UNomB(displayUnit = "V") = 1, X = 0.06736, rFixed = 1, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {-106, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      ...
      PowerGridsMC.Electrical.Loads.LoadPQW pq21(P(displayUnit = "W") = 2, Q(displayUnit = "var") = 1, SNom(displayUnit = "V.A") = 1, UNom(displayUnit = "V") = 1) annotation(
        Placement(visible = true, transformation(origin = {26, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.PowerFlow.PVBusW pv22(P(displayUnit = "W") = 0, SNom(displayUnit = "V.A") = 1, U(displayUnit = "V") = 0.98, UNom(displayUnit = "V") = 1) annotation(
        Placement(visible = true, transformation(origin = {108, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T2_22(SNom(displayUnit = "W") = 1, UNomA(displayUnit = "V") = 1, UNomB(displayUnit = "V") = 1, X = 2.7775, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {64, 0}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T22_21(SNom(displayUnit = "W") = 1, UNomA(displayUnit = "V") = 1, UNomB(displayUnit = "V") = 1, X = 0.17867, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {64, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T41_42x2(SNom(displayUnit = "W") = 1, UNomA(displayUnit = "V") = 1, UNomB(displayUnit = "V") = 1, X = 0.026926, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {18, -64}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Teq31_3(SNom(displayUnit = "W") = 1, UNomA(displayUnit = "V") = 1, UNomB(displayUnit = "V") = 1, X = 0.064909) annotation(
      ...
      PowerGridsMC.Electrical.Buses.Bus bus33(UNom(displayUnit = "V") = 1, SNom(displayUnit = "W") = 1) annotation(
        Placement(transformation(extent = {{-116, 26}, {-96, 46}})));
      PowerGridsMC.Electrical.Buses.Bus bus22(UNom(displayUnit = "V") = 1, SNom(displayUnit = "W") = 1) annotation(
        Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = -90, origin = {92, 14})));
      PowerGridsMC.Electrical.Buses.Bus bus11(UNom(displayUnit = "V") = 1, SNom(displayUnit = "W") = 1) annotation(
        Placement(transformation(extent = {{-18, 78}, {2, 98}})));
      PowerGridsMC.Electrical.Buses.Bus bus31(UNom(displayUnit = "V") = 1, SNom(displayUnit = "W") = 1) annotation(
        Placement(transformation(extent = {{-116, -34}, {-96, -14}})));
    equation
      connect(T11_1x2.terminalB, L2_1.terminalA) annotation(
        Line(points = {{-8, 60}, {-8, 50}}));
      connect(L3_2.terminalB, L2_1.terminalB) annotation(
      ...
      connect(T31_33x2.terminalB, Teq31_3.terminalA) annotation(
        Line(points = {{-106, 0}, {-106, -12}, {-92, -12}}));
      ...
      connect(T4_42x2.terminalA, Bus42.terminal) annotation(
        Line(points = {{10, -46}, {54, -46}}));
      connect(T4_42x2.terminalB, T4_41x2.terminalB) annotation(
        Line(points = {{-10, -46}, {-22, -46}, {-22, -56}}));
      connect(T4_42x2.terminalB, L3_4.terminalB) annotation(
        Line(points = {{-10, -46}, {-22, -46}, {-22, -30}, {-30, -30}}));
      connect(T41_42x2.terminalA, T4_42x2.terminalA) annotation(
        Line(points = {{18, -54}, {18, -46}, {10, -46}}));
      connect(pq41.terminal, T4_41x2.terminalA) annotation(
        Line(points = {{-22, -86}, {-22, -76}}));
      connect(T2_21d.terminalA, T2_22.terminalA) annotation(
        Line(points = {{46, 18}, {46, 0}, {54, 0}}));
      connect(Teq2_21u.terminalA, L2_1.terminalB) annotation(
        Line(points = {{16, 22}, {16, 12}, {-8, 12}, {-8, 30}}, color = {0, 0, 0}));
      connect(Teq2_21u.terminalB, pq21.terminal) annotation(
        Line(points = {{16, 42}, {16, 48}, {26, 48}, {26, 54}}, color = {0, 0, 0}));
      connect(pv33.terminal, bus33.terminal) annotation(
        Line(points = {{-106, 56}, {-106, 36}}, color = {0, 0, 0}));
      connect(bus33.terminal, T31_33x2.terminalA) annotation(
        Line(points = {{-106, 36}, {-106, 20}}, color = {0, 0, 0}));
      connect(T22_21.terminalB, T2_22.terminalB) annotation(
        Line(points = {{74, 40}, {80, 40}, {80, 0}, {74, 0}}, color = {0, 0, 0}));
      connect(bus22.terminal, T2_22.terminalB) annotation(
        Line(points = {{92, 14}, {80, 14}, {80, 0}, {74, 0}}, color = {0, 0, 0}));
      connect(pv22.terminal, bus22.terminal) annotation(
        Line(points = {{108, 14}, {92, 14}}, color = {0, 0, 0}));
      connect(T11_1x2.terminalA, bus11.terminal) annotation(
        Line(points = {{-8, 80}, {-8, 88}}, color = {0, 0, 0}));
      connect(pv11.terminal, bus11.terminal) annotation(
        Line(points = {{-8, 106}, {-8, 88}}, color = {0, 0, 0}));
      connect(T41_42x2.terminalB, pq41.terminal) annotation(
        Line(points = {{18, -74}, {18, -86}, {-22, -86}}, color = {0, 0, 0}));
      connect(pq31.terminal, bus31.terminal) annotation(
        Line(points = {{-106, -38}, {-106, -24}}, color = {0, 0, 0}));
      connect(bus31.terminal, Teq31_3.terminalA) annotation(
...
<p>10.04 kV (node 23) 126.9 kV (node 21)</p>
    ...
    model Bus1FaultSIunregulated
      ...
      //Real Expressions
      Modelica.Blocks.Sources.RealExpression pm11(y = -gen11x2.PStart/gen11x2.SNom) annotation(
        Placement(visible = true, transformation(origin = {-126, 72}, extent = {{-22, -8}, {22, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf42(y = gen42x2.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {0, -132}, extent = {{-8, -10}, {8, 10}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf33(y = gen33x2.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {-145, 30}, extent = {{-9, -10}, {9, 10}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression pm33(y = -gen33x2.PStart/gen33x2.SNom) annotation(
        Placement(visible = true, transformation(origin = {-142, 14}, extent = {{-12, -8}, {12, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf11(y = gen11x2.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {-120, 58}, extent = {{-16, -8}, {16, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression pm42(y = -gen42x2.PStart/gen42x2.SNom) annotation(
        Placement(visible = true, transformation(origin = {-1, -117}, extent = {{-7, -9}, {7, 9}}, rotation = 0)));
      ...
      Modelica.Blocks.Sources.RealExpression ufSC(y = sc22.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {66, 33}, extent = {{8, -9}, {-8, 9}}, rotation = 0)));
      //Loads
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR pq31(SNom(displayUnit = "V.A") = 100000000, UNom(displayUnit = "V") = 129e3, UPhaseStart(displayUnit = "rad"), UStart(displayUnit = "V"), alpha = alpha, beta = beta, portVariablesPhases = true) annotation(
        Placement(visible = true, transformation(origin = {-140.5, -73}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR pq21(SNom(displayUnit = "V.A") = 100000000, UNom(displayUnit = "V") = 127000, UPhaseStart(displayUnit = "rad"), UStart(displayUnit = "V"), alpha = alpha, beta = beta) annotation(
        Placement(visible = true, transformation(origin = {-22, 32}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR pq41(SNom(displayUnit = "V.A") = 100000000, UNom(displayUnit = "V") = 119000, UPhaseStart(displayUnit = "rad"), UStart(displayUnit = "V"), alpha = alpha, beta = beta) annotation(
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Teq31_3(R = 0.0948*230^2/160/30, SNom(displayUnit = "MW") = 160000000, UNomA(displayUnit = "kV") = 135000, UNomB(displayUnit = "kV") = 230000, X = 0.0948*230^2/160, rFixed = 230/135, showPortData = false) annotation(
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T31_33_2(R = 273/75e3*132^2/75, SNom(displayUnit = "MW") = 75000000, UNomA(displayUnit = "kV") = 13800, UNomB(displayUnit = "kV") = 132000, X = 0.0965*132^2/75, rFixed = 132/13.8, showPortData = false) annotation(
        Placement(visible = true, transformation(origin = {-130, -28}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T2_i(SNom(displayUnit = "MW") = 125000000, UNomA(displayUnit = "kV") = 230000, UNomB(displayUnit = "kV") = 230000, X = 71.884e-3*220^2/100, showPortData = false) annotation(
        Placement(visible = true, transformation(origin = {-2, -22}, extent = {{10, -10}, {-10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Teq2_21(R = 435/125e3*126.9^2/100, SNom(displayUnit = "MW") = 125000000, UNomA(displayUnit = "kV") = 230000, UNomB(displayUnit = "kV") = 132700, X = 0.0875*126.9^2/100, rFixed = 132.7/230, showPortData = false) annotation(
        Placement(visible = true, transformation(origin = {-26, -8}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T22_i(SNom(displayUnit = "MW") = 39000000, UNomA(displayUnit = "kV") = 230000, UNomB(displayUnit = "kV") = 10500, X = 0.1635*10.04^2/100, rFixed = 10.5/230, showPortData = false) annotation(
      ...
      //Buses
      PowerGridsMC.Electrical.Buses.BusFault bus1(R = 1, SNom(displayUnit = "V.A") = 500000000, UNom(displayUnit = "V") = 220000, X = 0, portVariablesPhases = true, portVariablesPu = true, startTime = 0.5, stopTime = 0.6) annotation(
      ...
      PowerGridsMC.Electrical.Buses.Bus bus3_3(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 13.8e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-109.5, 4.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus31(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 135e3, portVariablesPhases = true, portVariablesPu = true) annotation(
      ...
      Electrical.Buses.Bus bus42(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 15.7e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {34.5, -89.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      ...
      connect(gen42x2.pmPuIn, pm42.y) annotation(
        Line(points = {{23.6, -102.6}, {16, -102.6}, {16, -117}, {6.7, -117}}, color = {0, 0, 127}));
      connect(gen42x2.ufPuIn, uf42.y) annotation(
        Line(points = {{23.6, -110}, {22, -110}, {22, -132}, {8.8, -132}}, color = {0, 0, 127}));
      connect(gen42x2.omega, systemPowerGrids.omegaRefIn) annotation(
        Line(points = {{44.3, -100.1}, {50.1, -100.1}, {50.1, -99.8}, {51.2, -99.8}}, color = {0, 0, 127}));
      ...
      connect(uf11.y, gen11x2.ufPuIn) annotation(
        Line(points = {{-102.4, 58}, {-96, 58}, {-96, 70}, {-84, 70}, {-84, 66.4}}, color = {0, 0, 127}));
      connect(T31_33_2.terminalB, Teq31_3.terminalA) annotation(
        Line(points = {{-130, -38}, {-130, -50}, {-126, -50}}));
      connect(T31_33_1.terminalB, Teq31_3.terminalA) annotation(
        Line(points = {{-148, -38}, {-148, -50}, {-126, -50}}));
      connect(pm33.y, gen33x2.pmPuIn) annotation(
        Line(points = {{-128.8, 14}, {-126, 14}, {-126, 18}, {-120.4, 18}, {-120.4, 18.6}}, color = {0, 0, 127}));
      connect(gen33x2.ufPuIn, uf33.y) annotation(
        Line(points = {{-120.4, 26}, {-130, 26}, {-130, 30}, {-135.1, 30}}, color = {0, 0, 127}));
      connect(T22_i.terminalA, T2_i.terminalA) annotation(
      ...
      connect(sc22.terminal, T22_i.terminalB) annotation(
        Line(points = {{38, 18}, {38, -12}, {26, -12}}));
      connect(sc22.pmPuIn, pmSc.y) annotation(
        Line(points = {{48.4, 14.6}, {56, 14.6}, {56, 9}, {59.2, 9}}, color = {0, 0, 127}));
      connect(ufSC.y, sc22.ufPuIn) annotation(
        Line(points = {{57.2, 33}, {57.2, 22}, {48.4, 22}}, color = {0, 0, 127}));
      ...
      connect(pq21.terminal, T21_i.terminalB) annotation(
        Line(points = {{-22, 32}, {-22, 20}, {-2, 20}}));
      connect(T41_iX2.terminalB, pq41.terminal) annotation(
        Line(points = {{-28, -104}, {-28, -112}, {-44, -112}}));
      connect(Teq2_21.terminalA, L2_1.terminalB) annotation(
        Line(points = {{-26, -18}, {-26, -26}, {-52.5, -26}, {-52.5, -16.5}}, color = {0, 0, 0}));
      connect(gen33x2.terminal, bus3_3.terminal) annotation(
        Line(points = {{-110, 22}, {-110, 4.5}, {-109.5, 4.5}}, color = {0, 0, 0}));
      connect(pq31.terminal, bus31.terminal) annotation(
        Line(points = {{-140.5, -73}, {-139.5, -73}, {-139.5, -59.5}}, color = {0, 0, 0}));
      connect(bus31.terminal, Teq31_3.terminalA) annotation(
        Line(points = {{-139.5, -59.5}, {-139.5, -50}, {-126, -50}}, color = {0, 0, 0}));
      connect(T31_33_1.terminalA, T31_33_2.terminalA) annotation(
        Line(points = {{-148, -18}, {-148, -12}, {-130, -12}, {-130, -18}}, color = {0, 0, 0}));
      connect(bus3_3.terminal, T31_33_2.terminalA) annotation(
        Line(points = {{-109.5, 4.5}, {-109.5, -6}, {-138, -6}, {-138, -12}, {-130, -12}, {-130, -18}}, color = {0, 0, 0}));
      connect(gen11x2.terminal, bus11.terminal) annotation(
      ...
      connect(T42_iX2.terminalB, bus42.terminal) annotation(
        Line(points = {{6, -84}, {14, -84}, {14, -78}, {34.5, -78}, {34.5, -89.5}}, color = {0, 0, 0}));
      connect(bus42.terminal, gen42x2.terminal) annotation(
        Line(points = {{34.5, -89.5}, {34, -89.5}, {34, -106}}, color = {0, 0, 0}));
      annotation(
        Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}})),
...
<p>See for instance the AC node (1, 2, 3, 4) voltages, and the values of omegaPU variables of gen11x2, gen22x2, gen42x2, sc22.</p>
    ...
    model Bus1FaultSIregulated
      ...
      Modelica.Blocks.Sources.RealExpression pm42(y = -gen42x2.PStart/gen42x2.SNom) annotation(
        Placement(visible = true, transformation(origin = {-9, -115}, extent = {{-15, -9}, {15, 9}}, rotation = 0)));
      PowerGridsMC.Electrical.Machines.SynchronousMachine4WindingsR gen42x2(H = 4, SNom = 1000000*(206*2e6), Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, UNom = 15700, portVariablesPhases = true, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8) annotation(
        Placement(visible = true, transformation(origin = {34, -108}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf42(y = gen42x2.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {-9, -128}, extent = {{-15, -8}, {15, 8}}, rotation = 0)));
      ...
      PFTdemo.Support.ReferenceBusRnew bus42(SNom(displayUnit = "V.A") = 5e+08, UNom(displayUnit = "V") = 10e3, portVariablesPhases = true, nameShort = "gen42x2", portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {18, -86}, extent = {{-10, 10}, {10, -10}}, rotation = 90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T41_iX2(SNom(displayUnit = "MW") = 190e6*2, UNomA(displayUnit = "kV") = 236100, UNomB(displayUnit = "kV") = 127900, X = 0.02476*119^2/100/2, rFixed = 127.9/236.1, showPortData = false) annotation(
        Placement(visible = true, transformation(origin = {-28, -96}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.Buses.Bus bus3(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-95.5, -51.5}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR pq21(SNom(displayUnit = "V.A") = 100000000, UNom(displayUnit = "V") = 127000, UPhaseStart(displayUnit = "rad"), UStart(displayUnit = "V"), alpha = alpha, beta = beta) annotation(
        Placement(visible = true, transformation(origin = {0, 30}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR pq41(SNom(displayUnit = "V.A") = 100000000, UNom(displayUnit = "V") = 119000, UPhaseStart(displayUnit = "rad"), UStart(displayUnit = "V"), alpha = alpha, beta = beta) annotation(
        Placement(visible = true, transformation(origin = {-44, -114}, extent = {{-10, 10}, {10, -10}}, rotation = 90)));
      // Buses
      PowerGridsMC.Electrical.Buses.Bus bus33(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 13.8e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-139.75, 2.25}, extent = {{-9.75, -9.75}, {9.75, 9.75}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus31(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 135e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-141.5, -61.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Examples.Tutorial.GridOperation.Controlled.ControlledGenPSS_R gen11x2(GEN(H = 4, SNom = 200000000, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, UNom = 13800, portVariablesPhases = true, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8)) annotation(
        Placement(transformation(extent = {{-62, 76}, {-42, 56}})));
      PowerGridsMC.Electrical.Buses.Bus bus2(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-31.5, -29.5}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Examples.Tutorial.GridOperation.Controlled.ControlledGenPSS_R gen33x2(GEN(H = 4, SNom = 120000000, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, UNom = 13800, portVariablesPhases = true, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8)) annotation(
        Placement(transformation(extent = {{-150, 36}, {-130, 16}})));
      PowerGridsMC.Examples.IEEE14bus.SynchronousCondenserR sc22(GEN(DPu = 0.0, H = 5.625, Tppd0 = 0.065, xpdPu = 0.509, Tpd0 = 10.041, raPu = 0.00316, xpqPu = 0.601, Tppq0 = 0.094, Tpq0 = 1.22, xppdPu = 0.354, xdPu = 2.81, xlPu = 0.256, xppqPu = 0.377, xqPu = 2.62, PNom = 40e6, SNom = 60e6, UNom = 13.8e3)) annotation(
        Placement(visible = true, transformation(origin = {64, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus11(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 13.8e3, portVariablesPhases = true, portVariablesPu = true) annotation(
    ...
    equation
      ...
      connect(T1_11_2.terminalB, T1_11_1.terminalB) annotation(
        Line(points = {{-45, 20.5}, {-45, 19.5}, {-61.5, 19.5}}));
      connect(L3_2.terminalB, L2_1.terminalB) annotation(
        Line(points = {{-61, -29}, {-52.5, -29}, {-52.5, -18.5}}, color = {0, 0, 0}));
      connect(L2_1.terminalB, L4_2.terminalA) annotation(
        Line(points = {{-52.5, -18.5}, {-52.5, -39}, {-52, -39}}));
      connect(L4_2.terminalB, L3_4.terminalB) annotation(
        Line(points = {{-52, -59}, {-51.75, -59}, {-51.75, -69}, {-61.5, -69}}));
      connect(gen42x2.pmPuIn, pm42.y) annotation(
        Line(points = {{23.6, -104.6}, {14, -104.6}, {14, -115}, {7.5, -115}}, color = {0, 0, 127}));
      connect(gen42x2.ufPuIn, uf42.y) annotation(
        Line(points = {{23.6, -112}, {16, -112}, {16, -128}, {7.5, -128}}, color = {0, 0, 127}));
      connect(gen42x2.omega, systemPowerGrids.omegaRefIn) annotation(
        Line(points = {{44.3, -102.1}, {50.1, -102.1}, {50.1, -101.8}, {51.2, -101.8}}, color = {0, 0, 127}));
      connect(T31_33_2.terminalB, Teq31_3.terminalA) annotation(
        Line(points = {{-130, -40}, {-130, -52}, {-126, -52}}));
      connect(T31_33_1.terminalB, Teq31_3.terminalA) annotation(
        Line(points = {{-148, -40}, {-148, -52}, {-126, -52}}));
      connect(T22_i.terminalA, T2_i.terminalA) annotation(
        Line(points = {{12, -14}, {4, -14}}));
      connect(Teq2_21.terminalA, T2_i.terminalB) annotation(
        Line(points = {{-20, -20}, {-20, -40}, {4, -40}, {4, -34}}));
      connect(T21_i.terminalA, T2_i.terminalA) annotation(
        Line(points = {{4, -2}, {4, -14}}));
      connect(T21_i.terminalB, Teq2_21.terminalB) annotation(
        Line(points = {{4, 18}, {-20, 18}, {-20, 0}}));
      connect(T1_11_1.terminalB, bus1.terminal) annotation(
        Line(points = {{-61.5, 19.5}, {-52, 19.5}, {-52, 10}}));
      connect(L2_1.terminalA, bus1.terminal) annotation(
        Line(points = {{-52.5, 1.5}, {-52.5, 6}, {-52, 6}, {-52, 10}}));
      connect(T42_iX2.terminalB, bus42.terminal) annotation(
        Line(points = {{6, -86}, {18, -86}}));
      connect(T42_iX2.terminalA, T41_iX2.terminalA) annotation(
        Line(points = {{-14, -86}, {-28, -86}}));
      connect(T41_iX2.terminalA, T4_iX2.terminalA) annotation(
        Line(points = {{-28, -86}, {-28, -82}}));
      connect(T4_iX2.terminalB, L4_2.terminalB) annotation(
        Line(points = {{-28, -62}, {-52, -62}, {-52, -59}}));
      connect(bus42.terminal, gen42x2.terminal) annotation(
        Line(points = {{18, -86}, {34, -86}, {34, -108}}));
      connect(Teq31_3.terminalB, bus3.terminal) annotation(
        Line(points = {{-106, -52}, {-102, -52}, {-102, -51.5}, {-95.5, -51.5}}));
      connect(L3_2.terminalA, bus3.terminal) annotation(
        Line(points = {{-81, -29}, {-88, -29}, {-88, -51.5}, {-95.5, -51.5}}));
      connect(L3_4.terminalA, bus3.terminal) annotation(
        Line(points = {{-81.5, -69}, {-88, -69}, {-88, -51.5}, {-95.5, -51.5}}));
      connect(pq21.terminal, T21_i.terminalB) annotation(
        Line(points = {{0, 30}, {0, 18}, {4, 18}}));
      connect(T41_iX2.terminalB, pq41.terminal) annotation(
        Line(points = {{-28, -106}, {-28, -114}, {-44, -114}}));
      connect(pq31.terminal, bus31.terminal) annotation(
        Line(points = {{-142.5, -75}, {-141.5, -75}, {-141.5, -61.5}}, color = {0, 0, 0}));
      connect(bus31.terminal, Teq31_3.terminalA) annotation(
        Line(points = {{-141.5, -61.5}, {-141.5, -52}, {-126, -52}}, color = {0, 0, 0}));
      connect(T31_33_1.terminalA, T31_33_2.terminalA) annotation(
        Line(points = {{-148, -20}, {-148, -14}, {-130, -14}, {-130, -20}}, color = {0, 0, 0}));
      connect(bus33.terminal, T31_33_2.terminalA) annotation(
        Line(points = {{-139.75, 2.25}, {-139.75, -14}, {-130, -14}, {-130, -20}}, color = {0, 0, 0}));
      connect(bus2.terminal, T2_i.terminalB) annotation(
        Line(points = {{-31.5, -29.5}, {-20, -29.5}, {-20, -40}, {4, -40}, {4, -34}}, color = {0, 0, 0}));
      connect(bus2.terminal, L2_1.terminalB) annotation(
        Line(points = {{-31.5, -29.5}, {-52.5, -29.5}, {-52.5, -18.5}}, color = {0, 0, 0}));
      connect(gen33x2.terminal, bus33.terminal) annotation(
        Line(points = {{-140, 26}, {-140, 2.25}, {-139.75, 2.25}}, color = {0, 0, 0}));
      connect(gen11x2.terminal, bus11.terminal) annotation(
        Line(points = {{-52, 66}, {-51.5, 66}, {-51.5, 50.5}}, color = {0, 0, 0}));
      connect(bus11.terminal, T1_11_1.terminalA) annotation(
        Line(points = {{-51.5, 50.5}, {-51.5, 42}, {-61.5, 42}, {-61.5, 39.5}}, color = {0, 0, 0}));
      connect(T22_i.terminalB, bus22.terminal) annotation(
...
cambio i gen eccetto lo slack"), Text(extent = {{-20, 60}, {64, 52}}, textColor = {238, 46, 47}, textString = "OK")}),
        ...
        Documentation(info = "<html>
<p>Model with data linked with PowerFlow.</p>
<p>Progressively introducing controlled generator Up to now 11 and 33.</p>
<p>All initial voltages have the same values as in PowerFlowSI</p>
<p>Checked: Bus1, Bus2, Bus31, Bus33.</p>
</html>"));
...
<p>See info of individual models for details.</p>
  ...
  package IEEE14
    model PowerFlowSI "Power flow model of the IEEE 14-bus benchmark"
      extends Modelica.Icons.Example;
      Modelica.Units.SI.Power totalLosses = -(Load2.port.P + Load3.port.P + Load4.port.P + Load5.port.P + Load6.port.P + Load9.port.P + Load10.port.P + Load11.port.P + Load12.port.P + Load13.port.P + Load13.port.P + GEN1.port.P + GEN2.port.P);
      inner PowerGridsMC.Electrical.System systemPowerGrids(showDataOnDiagramsPu = false) annotation(
        Placement(transformation(origin = {134, 90}, extent = {{-10, -10}, {10, 10}})));
      // Buses
      PowerGridsMC.Electrical.PowerFlow.SlackBusW bus1(SNom = 100e6, U = 69e3*1.0598, UNom = 69000) annotation(
      ...
      PowerGridsMC.Electrical.Branches.LineConstantImpedance L1to2(portVariablesPhases = true, R = 0.922682, X = 2.81708, G = 0, B = 0.00110901, SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {-148, -30}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.Branches.LineConstantImpedanceWithBreakers L1to5(portVariablesPhases = true, useBreakerA = false, useBreakerB = false, R = 2.57237, X = 10.6189, B = 0.0010334, G = 0, SNom = 100000000, UNom = 69000) annotation(
        Placement(visible = true, transformation(origin = {-102, -46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Branches.LineConstantImpedance L2to3(portVariablesPhases = true, R = 2.23719, X = 9.42535, G = 0, B = 0.000919975, SNom = 100000000, UNom = 69000, showPortData = true) annotation(
      ...
      PowerGridsMC.Electrical.Branches.LineConstantImpedance L6to12(portVariablesPhases = true, R = 0.23407, X = 0.487165, G = 0, B = 0, SNom = 100e6, UNom = 13.8e3) annotation(
      ...
      PowerGridsMC.Electrical.Branches.LineConstantImpedance L12to13(portVariablesPhases = true, R = 0.42072, X = 0.380651, G = 0, B = 0, SNom = 100000000, UNom = 13800, showPortData = true) annotation(
      ...
      // LOADS
      PowerGridsMC.Electrical.Loads.LoadPQW Load2(portVariablesPhases = true, P = 21.7e6, Q = 12.7e6, SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {-88, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load3(portVariablesPhases = true, P = 94.2e6, Q = 19.1e6, SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {88, -98}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load4(portVariablesPhases = true, P = 47.8e6, Q = -3.9e6, SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {112, -54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load5(portVariablesPhases = true, P = 7.6e6, Q = 1.6e6, SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {-74, -26}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load6(portVariablesPhases = true, P = 11.2e6, Q = 7.5e6, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {-26, -14}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load9(portVariablesPhases = true, showPortData = true, P = 29.5e6, Q = 16.6e6, SNom = 100000000, UNom = 13800) annotation(
        Placement(visible = true, transformation(origin = {106, 56}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load10(portVariablesPhases = true, P = 9e6, Q = 5.8e6, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {24, 52}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load11(portVariablesPhases = true, P = 3.5e6, Q = 1.8e6, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {-24, 52}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load12(portVariablesPhases = true, P = 6100000, Q = 1600000, SNom = 100000000, UNom = 13800, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {-106, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load13(portVariablesPhases = true, P = 13800000, Q = 5800000, SNom = 100000000, UNom = 13800, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {-46, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadPQW Load14(portVariablesPhases = true, P = 14900000, Q = 5000000, SNom = 100000000, UNom = 13800, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {14, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      // Capacitor bank
      PowerGridsMC.Electrical.Banks.CapacitorBankFixed Cbank9(portVariablesPhases = true, showPortData = true, B = 0.099769, SNom = 100000000, UNom = 13800) annotation(
        Placement(visible = true, transformation(origin = {84, 56}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      // Transformers
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T4to7(portVariablesPhases = true, R = 0, X = 0.398248, B = 0, G = 0, rFixed = 0.204082, SNom = 100e6, UNomA = 69e3, UNomB = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {88, -18}, extent = {{10, 10}, {-10, -10}}, rotation = -90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T4to9(portVariablesPhases = true, R = 0, X = 1.05919, B = 0, G = 0, rFixed = 0.208333, SNom = 100e6, UNomA = 69.0e3, UNomB = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {76, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T5to6(portVariablesPhases = true, R = 0, X = 0.479948, B = 0, G = 0, rFixed = 0.212766, SNom = 100e6, UNomA = 69e3, UNomB = 13.8e3) annotation(
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Tgen8(portVariablesPhases = true, R = 0, X = 0.076176, B = 0, G = 0, rFixed = 0.766667, SNom = 250e6, UNomA = 18e3, UNomB = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {148, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      // Generators
      PowerGridsMC.Electrical.PowerFlow.PVBusW GEN1(portVariablesPhases = true, SNom = 1211000000, UNom = 24000, P(displayUnit = "MW") = -234000000.0, U(displayUnit = "kV") = 25575.0) annotation(
        Placement(transformation(origin = {-142, 46}, extent = {{10, -10}, {-10, 10}}, rotation = -180)));
      PowerGridsMC.Electrical.PowerFlow.PVBusW GEN2(portVariablesPhases = true, SNom = 1120000000, UNom = 24000, U = 24000, P = -40000000) annotation(
        Placement(visible = true, transformation(origin = {-138, -92}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.PowerFlow.PVBusW GEN3(portVariablesPhases = true, SNom = 1650000000, UNom = 20000, U = 20000, P = 0) annotation(
        Placement(visible = true, transformation(origin = {142, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.PowerFlow.PVBusW GEN6(portVariablesPhases = true, SNom = 80000000, UNom = 13800, U = 13800, P = 0) annotation(
        Placement(visible = true, transformation(origin = {-86, 0}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.PowerFlow.PVBusW GEN8(portVariablesPhases = true, SNom = 250000000, UNom = 18000, U = 18000, P = 0) annotation(
    ...
    equation
      ...
      annotation(
        Diagram(coordinateSystem(extent = {{-160, -120}, {160, 120}}), graphics = {Text(extent = {{78, 98}, {100, 92}}, lineColor = {238, 46, 47}, textString = DynamicSelect("Plost", String(totalLosses/1e6, format = "8.2f"))), Rectangle(extent = {{52, 106}, {102, 90}}, lineColor = {28, 108, 200}, lineThickness = 1), Text(extent = {{48, 104}, {104, 98}}, textColor = {238, 46, 47}, textString = "Total losses (MW):")}),
        experiment(Interval = 0.002, Tolerance = 1e-07, __Dymola_Algorithm = "Dassl"),
        __OpenModelica_commandLineOptions = "--daeMode --tearingMethod=minimalTearing",
...
<p>This technique allows to reuse these output as initial values for subsequent transients, e.g. those proposed in StaticNetworkUnreg model.</p>
    ...
    model StaticNetworkUnreg "Dynamic model of the IEEE 14-bus system, operating in steady-state"
      extends Modelica.Icons.Example;
      inner PowerGridsMC.Electrical.System systemPowerGrids(initOpt = PowerGridsMC.Types.Choices.InitializationOption.globalSteadyStateFixedPowerFlow, referenceFrequency = PowerGridsMC.Types.Choices.ReferenceFrequency.fixedReferenceGenerator, showDataOnDiagramsPu = false) annotation(
      ...
      // Loads
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load2(alpha = 1.5, beta = 2.5) annotation(
        Placement(visible = true, transformation(origin = {-104, -98}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load3(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {104, -94}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load4(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {124, -54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load5(alpha = 1.5, beta = 2.5) annotation(
        Placement(visible = true, transformation(origin = {-64, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load6(alpha = 1.5, beta = 2.5) annotation(
        Placement(visible = true, transformation(origin = {-22, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load9(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {118, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load10(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {26, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load11(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {-24, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load12(alpha = 1.5, beta = 2.5) annotation(
        Placement(visible = true, transformation(origin = {-104, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load13(alpha = 1.5, beta = 2.5) annotation(
        Placement(visible = true, transformation(origin = {-44, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load14(alpha = 1.5, beta = 2.5) annotation(
      ...
      // Generators
      PowerGridsMC.Electrical.Machines.SynchronousMachine4WindingsR GEN1(SNom = 1211000000, UNom = 24000, H = 4, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8) annotation(
        Placement(transformation(origin = {-138, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Machines.SynchronousMachine4WindingsR GEN2(SNom = 1120000000, UNom = 24000, H = 4, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8) annotation(
        Placement(transformation(origin = {-158, -90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.Machines.SynchronousMachine4WindingsR GEN3(SNom = 1650000000, UNom = 20000, H = 4, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8) annotation(
        Placement(visible = true, transformation(origin = {158, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Machines.SynchronousMachine4WindingsR GEN6(SNom = 80000000, UNom = 13800, H = 4, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8) annotation(
        Placement(visible = true, transformation(origin = {-84, -10}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.Machines.SynchronousMachine4WindingsR GEN8(SNom = 250000000, UNom = 18000, H = 4, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8) annotation(
        Placement(visible = true, transformation(origin = {164, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf1(y = GEN1.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {-105, 50}, extent = {{9, -8}, {-9, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression pm1(y = -GEN1.PStart/GEN1.SNom) annotation(
        Placement(visible = true, transformation(origin = {-104, 36}, extent = {{12, -8}, {-12, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf8(y = GEN8.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {133, -38}, extent = {{-9, -8}, {9, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression pm8(y = -GEN8.PStart/GEN8.SNom) annotation(
        Placement(visible = true, transformation(origin = {134, -26}, extent = {{-12, -8}, {12, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf6(y = GEN6.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {-101, 10}, extent = {{-9, -8}, {9, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression pm6(y = -GEN6.PStart/GEN6.SNom) annotation(
        Placement(visible = true, transformation(origin = {-64, 20}, extent = {{12, -8}, {-12, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf2(y = GEN2.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {-173, -73}, extent = {{-9, -7}, {9, 7}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression pm2(y = -GEN2.PStart/GEN2.SNom) annotation(
        Placement(visible = true, transformation(origin = {-164, -60}, extent = {{-12, -8}, {12, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf3(y = GEN3.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {143, -114}, extent = {{-9, -8}, {9, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression pm3(y = -GEN3.PStart/GEN3.SNom) annotation(
        Placement(visible = true, transformation(origin = {126, -104}, extent = {{-12, -8}, {12, 8}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus15(SNom = 100000000, UNom = 24000) annotation(
        Placement(visible = true, transformation(origin = {-144, -90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.Buses.Bus busG8(SNom = 100000000, UNom = 18000) annotation(
    ...
    equation
      ...
      connect(GEN1.omega, systemPowerGrids.omegaRefIn) annotation(
        Line(points = {{-148.3, 40.1}, {-163, 40.1}, {-163, 80.2}, {-156.8, 80.2}}, color = {0, 0, 127}));
      connect(GEN1.ufPuIn, uf1.y) annotation(
        Line(points = {{-127.6, 50}, {-114.9, 50}}, color = {0, 0, 127}));
      connect(GEN1.pmPuIn, pm1.y) annotation(
        Line(points = {{-127.6, 42.6}, {-127.6, 42}, {-122, 42}, {-122, 36}, {-117.2, 36}}, color = {0, 0, 127}));
      connect(pm8.y, GEN8.pmPuIn) annotation(
        Line(points = {{147.2, -26}, {144, -26.6}, {153.6, -26.6}}, color = {0, 0, 127}));
      connect(GEN8.ufPuIn, uf8.y) annotation(
        Line(points = {{153.6, -34}, {146, -34}, {146, -38}, {142.9, -38}}, color = {0, 0, 127}));
      connect(pm6.y, GEN6.pmPuIn) annotation(
        Line(points = {{-77.2, 20}, {-80, 20}, {-80, 0.4}, {-80.6, 0.4}}, color = {0, 0, 127}));
      connect(uf6.y, GEN6.ufPuIn) annotation(
        Line(points = {{-91.1, 10}, {-88, 10}, {-88, 0.4}}, color = {0, 0, 127}));
      connect(GEN2.ufPuIn, uf2.y) annotation(
        Line(points = {{-162, -79.6}, {-162, -73}, {-163.1, -73}}, color = {0, 0, 127}));
      connect(pm2.y, GEN2.pmPuIn) annotation(
        Line(points = {{-150.8, -60}, {-148, -60}, {-148, -72}, {-154, -72}, {-154, -79.6}, {-154.6, -79.6}}, color = {0, 0, 127}));
      connect(GEN3.ufPuIn, uf3.y) annotation(
        Line(points = {{162, -100.4}, {162, -114}, {152.9, -114}}, color = {0, 0, 127}));
      connect(GEN3.pmPuIn, pm3.y) annotation(
        Line(points = {{154.6, -100.4}, {154.6, -104}, {139.2, -104}}, color = {0, 0, 127}));
      connect(GEN2.terminal, bus15.terminal) annotation(
        Line(points = {{-158, -90}, {-144, -90}}, color = {0, 0, 0}));
      connect(bus15.terminal, Tgen2.terminalA) annotation(
        Line(points = {{-144, -90}, {-138, -90}}, color = {0, 0, 0}));
      connect(busG8.terminal, GEN8.terminal) annotation(
        Line(points = {{164, -16}, {164, -30}}, color = {0, 0, 0}));
      connect(Tgen8.terminalA, busG8.terminal) annotation(
        Line(points = {{164, -6}, {164, -16}}, color = {0, 0, 0}));
      annotation(
...
<p>- it recovers from disk power flow outputs, obtained using PowerFlowSI model. In this way we have here a &quot;transient&quot;, in which, however, nothing changes over time. It shows that the passage of PF output to transient-enabled models through the disk saving/retrieving mechanism works well.</p>
    ...
    model StaticNetworkReg "Dynamic model of the IEEE 14-bus system, operating in steady-state, no regulators"
      extends Modelica.Icons.Example;
      inner PowerGridsMC.Electrical.System systemPowerGrids(initOpt = PowerGridsMC.Types.Choices.InitializationOption.globalSteadyStateFixedPowerFlow, referenceFrequency = PowerGridsMC.Types.Choices.ReferenceFrequency.fixedReferenceGenerator, showDataOnDiagramsPu = false) annotation(
        Placement(transformation(origin = {-146, 80}, extent = {{-10, -10}, {10, 10}})));
      // Buses
      ...
      PowerGridsMC.Electrical.Buses.Bus bus2(SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {-104, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.BusFault busG2(SNom = 100000000, UNom = 24000, R = 1, startTime = 1e6, stopTime = 2e6) annotation(
        Placement(visible = true, transformation(origin = {-144, -90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.Buses.Bus bus3(SNom = 100e6, UNom = 69e3) annotation(
      ...
      PowerGridsMC.Electrical.Branches.LineConstantImpedance L13to14(portVariablesPhases = true, R = 0.325519, X = 0.662763, G = 0, B = 0, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {-14, 72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      // Loads
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load2(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {-104, -98}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load3(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 69e3) annotation(
      ...
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load5(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 69e3) annotation(
        Placement(visible = true, transformation(origin = {-74, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load6(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {-22, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load9(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 13.8e3) annotation(
      ...
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load11(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {-24, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load12(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {-104, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load13(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {-44, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR Load14(alpha = 1.5, beta = 2.5, SNom = 100e6, UNom = 13.8e3) annotation(
        Placement(visible = true, transformation(origin = {16, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
      // Capacitor Bank
      PowerGridsMC.Electrical.Banks.CapacitorBankFixed Cbank9(B = 0.099769, SNom = 100e6, UNom = 13.8e3) annotation(
      ...
      // Generators
      PowerGridsMC.Examples.IEEE14bus.ControlledGenNoPSS_R GEN1(GEN(SNom = 1211000000, UNom = 24000, H = 4, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8)) annotation(
        Placement(transformation(origin = {-138, 52}, extent = {{10, 10}, {-10, -10}}, rotation = 0)));
      PowerGridsMC.Examples.IEEE14bus.ControlledGenNoPSS_R GEN2(GEN(DPu = 0.0, H = 5.4, Tppd0 = 0.058, xpdPu = 0.407, Tpd0 = 9.651, raPu = 0.00357, xpqPu = 0.454, Tppq0 = 0.06, Tpq0 = 1.009, xppdPu = 0.3, xdPu = 2.57, xlPu = 0.219, xppqPu = 0.301, xqPu = 2.57, PNom = 1008e6, SNom = 1120e6, UNom = 24e3)) annotation(
        Placement(transformation(origin = {-162, -90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Examples.IEEE14bus.SynchronousCondenserR GEN3(GEN(SNom = 1650000000, UNom = 20000, H = 4, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8)) annotation(
        Placement(visible = true, transformation(origin = {162, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Examples.IEEE14bus.SynchronousCondenserR GEN6(GEN(SNom = 80000000, UNom = 13800, H = 4, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8)) annotation(
        Placement(transformation(origin = {-80, 0}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Examples.IEEE14bus.SynchronousCondenserR GEN8(GEN(SNom = 250000000, UNom = 18000, H = 4, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8)) annotation(
        Placement(visible = true, transformation(origin = {162, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Electrical.Buses.BusFault busG1(R = 0.01, startTime = 1, stopTime = 2, SNom = 100000000, UNom = 24000) annotation(
        Placement(visible = true, transformation(origin = {-158, 36}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
    equation
      connect(bus12.terminal, L6to12.terminalB) annotation(
        Line(points = {{-104, 80}, {-106, 80}, {-106, 60}, {-84, 60}}));
      connect(L12to13.terminalA, bus12.terminal) annotation(
      ...
      connect(busG2.terminal, Tgen2.terminalA) annotation(
        Line(points = {{-144, -90}, {-138, -90}}, color = {0, 0, 0}));
      connect(Tgen8.terminalA, busG8.terminal) annotation(
        Line(points = {{162, -6}, {162, -16}}, color = {0, 0, 0}));
      connect(GEN2.terminal, Tgen2.terminalA) annotation(
        Line(points = {{-162, -90}, {-138, -90}}));
      connect(Tgen3.terminalA, GEN3.terminal) annotation(
        Line(points = {{142, -90}, {162, -90}}, color = {0, 0, 0}));
      connect(busG8.terminal, GEN8.terminal) annotation(
        Line(points = {{162, -16}, {162, -36}}, color = {0, 0, 0}));
      connect(GEN6.terminal, bus6.terminal) annotation(
        Line(points = {{-80, 0}, {-44, 0}}, color = {0, 0, 0}));
      connect(GEN1.terminal, Tgen1.terminalA) annotation(
        Line(points = {{-138, 52}, {-138, 30}}, color = {0, 0, 0}));
      connect(GEN1.omega, systemPowerGrids.omegaRefIn) annotation(
        Line(points = {{-149, 52}, {-170, 52}, {-170, 80.2}, {-156.8, 80.2}}, color = {0, 0, 127}));
      connect(busG1.terminal, Tgen1.terminalA) annotation(
        Line(points = {{-158, 36}, {-138, 36}, {-138, 30}}, color = {0, 0, 0}));
      annotation(
        Diagram(coordinateSystem(extent = {{-180, 120}, {180, -120}})),
        experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-6, Interval = 0.002),
        Documentation(info = "<html>
...
<p>- it recovers from disk power flow outputs, obtained using PowerFlowSI model. In this way we have here a &quot;transient&quot;, in which, however, nothing changes over time. It shows that the passage of PF output to transient-enabled models trhough the disk saving/retrieving mechanism works well.</p>
    ...
    package DerivedCases
      model Line1to5Opening
        extends IEEE14.StaticNetworkReg(L1to5(useBreakerB = true));
      ...
      model Gen2Disconnection
        extends IEEE14.StaticNetworkReg(Tgen2(useBreaker = true));
        Modelica.Blocks.Sources.BooleanExpression breakerState(y = time < 1) annotation(
          Placement(visible = true, transformation(origin = {-162, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(breakerState.y, Tgen2.breakerStatusIn) annotation(
          Line(points = {{-151, -72}, {-122, -72}, {-122, -89}, {-121, -89}}, color = {255, 0, 255}));
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false)),
          Diagram(coordinateSystem(preserveAspectRatio = false)),
          experiment(
      ...
      model BusFaultG1G2
        extends StaticNetworkReg(busG2(R = 0.01, startTime = 1e6, stopTime = 2e6), busG1(stopTime = 1.2));
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false)),
          Diagram(coordinateSystem(preserveAspectRatio = false)),
          experiment(StopTime = 20, Interval = 0.02, Tolerance = 1e-06, __Dymola_Algorithm = "Dassl"),
          Documentation(info = "<html>
...
<p>Here, however, we use the PFT technique, i.e. passage Power-Flow -&gt; Transient, which involves saving powerflow output and retrieving it in transient simulations.</p>
  ...
  package Experimental
    model GenSlackPF "Modello Paris SI con tensioni ai morsetti delle macchine unitarie"
      extends Modelica.Icons.Example;
      ...
      PowerGridsMC.Electrical.Loads.LoadPQW pq31(P(displayUnit = "MW") = 200000000, Q(displayUnit = "MVA") = 100000000, SNom(displayUnit = "MVA") = 100000000, UNom(displayUnit = "kV") = 129000) annotation(
        Placement(visible = true, transformation(origin = {-100, -42}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadPQW pq41(P(displayUnit = "MW") = 100000000, Q(displayUnit = "MVA") = 50000000, SNom(displayUnit = "MVA") = 100000000, UNom(displayUnit = "kV") = 119000, showPortData = false) annotation(
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T22_i(SNom(displayUnit = "MW") = 39000000, UNomA(displayUnit = "kV") = 230000, UNomB(displayUnit = "kV") = 10500, X = 0.1635*10.04^2/100, rFixed = 10.5/230, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {74, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T42_iX2(SNom(displayUnit = "MW") = 190e6*2, UNomA(displayUnit = "V") = 236.1, UNomB(displayUnit = "V") = 15.75, X = 0.017488*14.7^2/100/2, rFixed = 15.75/236.1, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {44, -70}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Teq31_3(R = 0.0948*230^2/160/30, SNom(displayUnit = "MW") = 160000000, UNomA(displayUnit = "kV") = 135000, UNomB(displayUnit = "kV") = 230000, X = 0.0948*230^2/160, rFixed = 230/135, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {-70, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Teq2_21(R = 435/125e3*126.9^2/100, SNom(displayUnit = "MW") = 125000000, UNomA(displayUnit = "kV") = 230000, UNomB(displayUnit = "kV") = 132700, X = 0.0875*126.9^2/100, rFixed = 132.7/230) annotation(
        Placement(visible = true, transformation(origin = {36, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      ...
      PowerGridsMC.Electrical.Buses.Bus bus33(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 13.8e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-95.5, 40.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus4(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {0.5, -31.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus31(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 135e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-99.5, -27.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus11(UNom(displayUnit = "kV") = 13800, SNom(displayUnit = "MVA") = 100000000) annotation(
        Placement(transformation(extent = {{-10, 82}, {10, 102}})));
      ...
      PowerGridsMC.Electrical.Buses.Bus bus42i(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 236, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {22.5, -69.5}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
    equation
      connect(L3_2.terminalB, L2_1.terminalB) annotation(
        Line(points = {{-12, 10}, {0, 10}, {0, 18}}));
      connect(L2_1.terminalB, L4_2.terminalA) annotation(
      ...
      connect(T31_33_2.terminalB, Teq31_3.terminalA) annotation(
        Line(points = {{-88, 4}, {-88, -12}, {-80, -12}}));
      connect(T21_i.terminalA, T2_i.terminalA) annotation(
        Line(points = {{56, 40}, {56, 28}}));
      connect(T22_i.terminalA, T2_i.terminalA) annotation(
        Line(points = {{64, 28}, {56, 28}}));
      connect(Teq2_21.terminalA, T2_i.terminalB) annotation(
        Line(points = {{36, 22}, {36, 8}, {56, 8}}));
      connect(T21_i.terminalB, Teq2_21.terminalB) annotation(
        Line(points = {{56, 60}, {36, 60}, {36, 42}}));
      connect(pq21.terminal, T21_i.terminalB) annotation(
        Line(points = {{56, 76}, {56, 60}}));
      connect(gen42x2.terminal, T42_iX2.terminalB) annotation(
        Line(points = {{64, -70}, {54, -70}}));
      connect(T41_iX2.terminalA, T4_iX2.terminalA) annotation(
        Line(points = {{0, -74}, {0, -62}}));
      connect(T41_iX2.terminalB, pq41.terminal) annotation(
        Line(points = {{0, -94}, {0, -100}, {16, -100}}));
      connect(T31_33_2.terminalA, T31_33_1.terminalA) annotation(
        Line(points = {{-88, 24}, {-88, 30}, {-106, 30}, {-106, 22}}, color = {0, 0, 0}));
      connect(bus3.terminal, Teq31_3.terminalB) annotation(
        Line(points = {{-47.5, -11.5}, {-54, -11.5}, {-54, -12}, {-60, -12}}, color = {0, 0, 0}));
      ...
      connect(T31_33_2.terminalA, bus33.terminal) annotation(
        Line(points = {{-88, 24}, {-88, 30}, {-95.5, 30}, {-95.5, 40.5}}, color = {0, 0, 0}));
      connect(T4_iX2.terminalB, bus4.terminal) annotation(
        Line(points = {{0, -42}, {0.5, -42}, {0.5, -31.5}}, color = {0, 0, 0}));
      connect(L4_2.terminalB, bus4.terminal) annotation(
        Line(points = {{0, -18}, {0, -31.5}, {0.5, -31.5}}, color = {0, 0, 0}));
      connect(pq31.terminal, bus31.terminal) annotation(
        Line(points = {{-100, -42}, {-100, -27.5}, {-99.5, -27.5}}, color = {0, 0, 0}));
      connect(bus31.terminal, Teq31_3.terminalA) annotation(
        Line(points = {{-99.5, -27.5}, {-99.5, -12}, {-80, -12}}, color = {0, 0, 0}));
      ...
      connect(bus2.terminal, L2_1.terminalB) annotation(
        Line(points = {{20.5, 8.5}, {0, 8.5}, {0, 18}}, color = {0, 0, 0}));
      connect(bus2.terminal, T2_i.terminalB) annotation(
        Line(points = {{20.5, 8.5}, {34, 8.5}, {34, 8}, {56, 8}}, color = {0, 0, 0}));
      connect(T42_iX2.terminalA, bus42i.terminal) annotation(
        Line(points = {{34, -70}, {34, -69.5}, {22.5, -69.5}}, color = {0, 0, 0}));
    ...
    model BusSlackPF "Modello Paris SI con tensioni ai morsetti delle macchine unitarie"
      extends Modelica.Icons.Example;
      Modelica.Units.SI.Power totalLosses = -(gen11x2.port.P + gen42i.port.P + gen33x2.port.P + pq21.port.P + pq31.port.P + pq41.port.P);
      PowerGridsMC.Electrical.PowerFlow.PVBusW gen33x2(P(displayUnit = "MW") = -100000000, SNom(displayUnit = "MVA") = 120000000, U(displayUnit = "kV") = 13800, UNom(displayUnit = "kV") = 13800, portVariablesPhases = true) annotation(
        Placement(visible = true, transformation(origin = {-96, 58}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
      PowerGridsMC.Electrical.PowerFlow.SlackBusW gen42i(SNom(displayUnit = "MVA") = 100000000, U(displayUnit = "kV") = 232240, UNom(displayUnit = "kV") = 236000) annotation(
        Placement(visible = true, transformation(origin = {22, -68}, extent = {{-10, 10}, {10, -10}}, rotation = 90)));
      PowerGridsMC.Electrical.Loads.LoadPQW pq21(P(displayUnit = "MW") = 200000000, Q(displayUnit = "MVA") = 100000000, SNom(displayUnit = "MVA") = 100000000, UNom(displayUnit = "kV") = 127000, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {56, 76}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadPQW pq31(P(displayUnit = "MW") = 200000000, Q(displayUnit = "MVA") = 100000000, SNom(displayUnit = "MVA") = 100000000, UNom(displayUnit = "kV") = 129000) annotation(
        Placement(visible = true, transformation(origin = {-100, -42}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T22_i(SNom(displayUnit = "MW") = 39000000, UNomA(displayUnit = "kV") = 230000, UNomB(displayUnit = "kV") = 10500, X = 0.1635*10.04^2/100, rFixed = 10.5/230, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {74, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T42_iX2(SNom(displayUnit = "MW") = 190e6*2, UNomA(displayUnit = "V") = 236.1, UNomB(displayUnit = "V") = 15.75, X = 0.017488*14.7^2/100/2, rFixed = 15.75/236.1, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {44, -68}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Teq31_3(R = 0.0948*230^2/160/30, SNom(displayUnit = "MW") = 160000000, UNomA(displayUnit = "kV") = 135000, UNomB(displayUnit = "kV") = 230000, X = 0.0948*230^2/160, rFixed = 230/135, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {-70, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Teq2_21(R = 435/125e3*126.9^2/100, SNom(displayUnit = "MW") = 125000000, UNomA(displayUnit = "kV") = 230000, UNomB(displayUnit = "kV") = 132700, X = 0.0875*126.9^2/100, rFixed = 132.7/230) annotation(
        Placement(visible = true, transformation(origin = {36, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      ...
      inner PowerGridsMC.Electrical.System systemPowerGrids(showDataOnDiagramsPu = false) annotation(
        Placement(visible = true, transformation(origin = {-100, 98}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.PowerFlow.PVBusW gen42x2(P(displayUnit = "MW") = -211700000, SNom(displayUnit = "MVA") = 100000000, U(displayUnit = "kV") = 15700, UNom(displayUnit = "kV") = 15000, portVariablesPhases = true) annotation(
    ...
    equation
      ...
      connect(T31_33_2.terminalA, bus33.terminal) annotation(
        Line(points = {{-88, 24}, {-88, 30}, {-95.5, 30}, {-95.5, 40.5}}, color = {0, 0, 0}));
      connect(T4_iX2.terminalB, bus4.terminal) annotation(
        Line(points = {{0, -40}, {0.5, -40}, {0.5, -31.5}}, color = {0, 0, 0}));
      connect(L4_2.terminalB, bus4.terminal) annotation(
        Line(points = {{0, -18}, {0, -31.5}, {0.5, -31.5}}, color = {0, 0, 0}));
      connect(pq31.terminal, bus31.terminal) annotation(
        Line(points = {{-100, -42}, {-100, -27.5}, {-99.5, -27.5}}, color = {0, 0, 0}));
      ...
      connect(bus2.terminal, T2_i.terminalB) annotation(
        Line(points = {{20.5, 8.5}, {34, 8.5}, {34, 8}, {56, 8}}, color = {0, 0, 0}));
      connect(T42_iX2.terminalA, gen42i.terminal) annotation(
        Line(points = {{34, -68}, {22, -68}}, color = {0, 0, 0}));
      connect(gen42i.terminal, T4_iX2.terminalA) annotation(
        Line(points = {{22, -68}, {0, -68}, {0, -60}}, color = {0, 0, 0}));
      connect(T42_iX2.terminalB, gen42x2.terminal) annotation(
        Line(points = {{54, -68}, {66, -68}}, color = {0, 0, 0}));
      annotation(
        Diagram(coordinateSystem(extent = {{-120, 120}, {120, -100}}), graphics = {Text(extent = {{74, 104}, {96, 98}}, lineColor = {238, 46, 47}, textString = DynamicSelect("Plost", String(totalLosses/1e6, format = "8.2f") + " MW")), Rectangle(extent = {{64, 112}, {110, 96}}, lineColor = {28, 108, 200}, lineThickness = 1), Text(extent = {{68, 112}, {104, 102}}, textColor = {238, 46, 47}, horizontalAlignment = TextAlignment.Left, textString = "Total line losses:")}),
        Documentation(info = "<html>
    <p>Per i trasformatori a tre avvolgimenti <b>scelgo lo schema paris a stella con trasformatori ideali ai lati a pi&ugrave; bassa tensione</b>. Quindi: </p>
    <p>1) parto dai parametri nella base di sistema calcolati in &quot;Descrizione rete.docx&quot; </p>
    <p>2) li trasformo in ohm lato B (occorrer&agrave; usare tensione e potenza nominali usate per la conversione in base di sistema) </p>
    ...
    model UnregRefbus
      ...
      Modelica.Blocks.Sources.RealExpression pm42(y = -gen42x2.PStart/gen42x2.SNom) annotation(
        Placement(visible = true, transformation(origin = {-1, -117}, extent = {{-7, -9}, {7, 9}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression uf33(y = gen33x2.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {-145, 28}, extent = {{-9, -8}, {9, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression pm33(y = -gen33x2.PStart/gen33x2.SNom) annotation(
        Placement(visible = true, transformation(origin = {-140, 14}, extent = {{-12, -8}, {12, 8}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression pmSc(y = 0) annotation(
        Placement(visible = true, transformation(origin = {62, 9}, extent = {{8, -9}, {-8, 9}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression ufSC(y = sc22.ufPuInStart) annotation(
        Placement(visible = true, transformation(origin = {60, 33}, extent = {{8, -9}, {-8, 9}}, rotation = 0)));
      // Transformers
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T1_11_2(R = 377/110e3*240^2/110, SNom(displayUnit = "MW") = 110000000, UNomA(displayUnit = "kV") = 13800, UNomB(displayUnit = "kV") = 240000, X = 0.0999*240^2/110, rFixed = 240/13.8) annotation(
        Placement(visible = true, transformation(origin = {-45, 32.5}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T1_11_1(R = 377/110e3*240^2/110, SNom(displayUnit = "MW") = 110000000, UNomA(displayUnit = "kV") = 13800, UNomB(displayUnit = "kV") = 240000, X = 0.0999*240^2/110, rFixed = 240/13.8, showPortData = false) annotation(
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T2_i(SNom(displayUnit = "MW") = 125000000, UNomA(displayUnit = "kV") = 230000, UNomB(displayUnit = "kV") = 230000, X = 71.884e-3*220^2/100, showPortData = false) annotation(
        Placement(visible = true, transformation(origin = {2, -22}, extent = {{10, -10}, {-10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio Teq2_21(R = 435/125e3*126.9^2/100, SNom(displayUnit = "MW") = 125000000, UNomA(displayUnit = "kV") = 230000, UNomB(displayUnit = "kV") = 132700, X = 0.0875*126.9^2/100, rFixed = 132.7/230, showPortData = true) annotation(
      ...
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T42_iX2(SNom(displayUnit = "MW") = 190e6*2, UNomA(displayUnit = "V") = 236.1, UNomB(displayUnit = "V") = 15.75, X = 0.017488*14.7^2/100/2, rFixed = 15.75/236.1, showPortData = true) annotation(
        Placement(visible = true, transformation(origin = {-4, -84}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T4_iX2(SNom(displayUnit = "MW") = 190e6*2, UNomA(displayUnit = "kV") = 236100, UNomB(displayUnit = "kV") = 236100, X = 0.04828*220^2/100/2, showPortData = false) annotation(
        Placement(visible = true, transformation(origin = {-26, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Branches.TransformerFixedRatio T41_iX2(SNom(displayUnit = "MW") = 190e6*2, UNomA(displayUnit = "kV") = 236100, UNomB(displayUnit = "kV") = 127900, X = 0.02476*119^2/100/2, rFixed = 127.9/236.1, showPortData = false) annotation(
        Placement(visible = true, transformation(origin = {-26, -94}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      PowerGridsMC.Electrical.Buses.Bus bus3(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-95.5, -49.5}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      //Loads
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR pq21(SNom(displayUnit = "V.A") = 100000000, UNom(displayUnit = "V") = 127000, alpha = alpha, beta = beta) annotation(
        Placement(visible = true, transformation(origin = {-2, 32}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR pq41(SNom(displayUnit = "V.A") = 100000000, UNom(displayUnit = "V") = 119000, alpha = alpha, beta = beta) annotation(
        Placement(visible = true, transformation(origin = {-44, -112}, extent = {{-10, 10}, {10, -10}}, rotation = 90)));
      PowerGridsMC.Electrical.Loads.LoadAlphaBetaR pq31(SNom(displayUnit = "V.A") = 100000000, UNom(displayUnit = "V") = 129e3, alpha = alpha, beta = beta, portVariablesPhases = true) annotation(
        Placement(visible = true, transformation(origin = {-140.5, -73}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      // Buses
      PowerGridsMC.Electrical.Buses.Bus bus33(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 13.8e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-109.5, 4.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ...
      PowerGridsMC.Electrical.Buses.Bus bus11(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 13.8e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-51.5, 52.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus2(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-31.5, -37.5}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Buses.Bus bus4(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {-41.5, -57.5}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      PowerGridsMC.Electrical.Buses.BusFault bus1(R = 1, SNom(displayUnit = "V.A") = 500000000, UNom(displayUnit = "V") = 220000, X = 0, portVariablesPhases = true, portVariablesPu = true, startTime = 0.5e6, stopTime = 0.6e6) annotation(
        Placement(visible = true, transformation(origin = {-52, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      PowerGridsMC.Electrical.Buses.Bus bus22(SNom(displayUnit = "V.A") = 10E6, UNom(displayUnit = "V") = 10E3, portVariablesPhases = true, portVariablesPu = true) annotation(
        Placement(visible = true, transformation(origin = {32.5, 4.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Support.ReferenceBusRnew bus42(nameShort = "gen42x2") annotation(
        Placement(transformation(extent = {{24, -100}, {44, -80}})));
    equation
      connect(T1_11_2.terminalA, T1_11_1.terminalA) annotation(
        Line(points = {{-45, 42.5}, {-45, 44}, {-61.5, 44}, {-61.5, 41.5}}));
      connect(T1_11_2.terminalB, T1_11_1.terminalB) annotation(
        Line(points = {{-45, 22.5}, {-45, 21.5}, {-61.5, 21.5}}));
      connect(L3_2.terminalB, L2_1.terminalB) annotation(
        Line(points = {{-61, -33}, {-52.5, -33}, {-52.5, -20.5}}, color = {0, 0, 0}));
      connect(L2_1.terminalB, L4_2.terminalA) annotation(
        Line(points = {{-52.5, -20.5}, {-52.5, -37}, {-52, -37}}));
      connect(L4_2.terminalB, L3_4.terminalB) annotation(
        Line(points = {{-52, -57}, {-51.75, -57}, {-51.75, -67}, {-59.5, -67}}));
      connect(gen42x2.pmPuIn, pm42.y) annotation(
        Line(points = {{23.6, -102.6}, {16, -102.6}, {16, -117}, {6.7, -117}}, color = {0, 0, 127}));
      connect(gen42x2.ufPuIn, uf42.y) annotation(
        Line(points = {{23.6, -110}, {22, -110}, {22, -132}, {8.8, -132}}, color = {0, 0, 127}));
      ...
      connect(T31_33_1.terminalB, Teq31_3.terminalA) annotation(
        Line(points = {{-148, -38}, {-148, -50}, {-126, -50}}));
      connect(pm33.y, gen33x2.pmPuIn) annotation(
        Line(points = {{-126.8, 14}, {-126, 14}, {-126, 18}, {-120.4, 18}, {-120.4, 18.6}}, color = {0, 0, 127}));
      connect(gen33x2.ufPuIn, uf33.y) annotation(
        Line(points = {{-120.4, 26}, {-130, 26}, {-130, 28}, {-135.1, 28}}, color = {0, 0, 127}));
      connect(T22_i.terminalA, T2_i.terminalA) annotation(
        Line(points = {{10, -12}, {2, -12}}));
      connect(Teq2_21.terminalA, T2_i.terminalB) annotation(
        Line(points = {{-22, -18}, {-22, -38}, {2, -38}, {2, -32}}));
      connect(T21_i.terminalA, T2_i.terminalA) annotation(
        Line(points = {{2, 0}, {2, -12}}));
      connect(T21_i.terminalB, Teq2_21.terminalB) annotation(
        Line(points = {{2, 20}, {-22, 20}, {-22, 2}}));
      connect(sc22.pmPuIn, pmSc.y) annotation(
        Line(points = {{42.4, 18.6}, {50, 18.6}, {50, 9}, {53.2, 9}}, color = {0, 0, 127}));
      connect(ufSC.y, sc22.ufPuIn) annotation(
        Line(points = {{51.2, 33}, {51.2, 26}, {42.4, 26}}, color = {0, 0, 127}));
      connect(T1_11_1.terminalB, bus1.terminal) annotation(
        Line(points = {{-61.5, 21.5}, {-52, 21.5}, {-52, 12}}));
      connect(L2_1.terminalA, bus1.terminal) annotation(
        Line(points = {{-52.5, -0.5}, {-52.5, 8}, {-52, 8}, {-52, 12}}));
      connect(T42_iX2.terminalA, T41_iX2.terminalA) annotation(
        Line(points = {{-14, -84}, {-26, -84}}));
      connect(T41_iX2.terminalA, T4_iX2.terminalA) annotation(
        Line(points = {{-26, -84}, {-26, -80}}));
      connect(Teq31_3.terminalB, bus3.terminal) annotation(
        Line(points = {{-106, -50}, {-102, -50}, {-102, -49.5}, {-95.5, -49.5}}));
      connect(L3_2.terminalA, bus3.terminal) annotation(
        Line(points = {{-81, -33}, {-88, -33}, {-88, -49.5}, {-95.5, -49.5}}));
      connect(L3_4.terminalA, bus3.terminal) annotation(
        Line(points = {{-79.5, -67}, {-88, -67}, {-88, -49.5}, {-95.5, -49.5}}));
      connect(pq21.terminal, T21_i.terminalB) annotation(
        Line(points = {{-2, 32}, {-2, 20}, {2, 20}}));
      connect(T41_iX2.terminalB, pq41.terminal) annotation(
        Line(points = {{-26, -104}, {-26, -112}, {-44, -112}}));
      connect(gen33x2.terminal, bus33.terminal) annotation(
        Line(points = {{-110, 22}, {-110, 4.5}, {-109.5, 4.5}}, color = {0, 0, 0}));
      connect(pq31.terminal, bus31.terminal) annotation(
        Line(points = {{-140.5, -73}, {-139.5, -73}, {-139.5, -59.5}}, color = {0, 0, 0}));
      ...
      connect(bus11.terminal, T1_11_1.terminalA) annotation(
        Line(points = {{-51.5, 52.5}, {-52, 44}, {-61.5, 44}, {-61.5, 41.5}}, color = {0, 0, 0}));
      connect(L4_2.terminalA, bus2.terminal) annotation(
        Line(points = {{-52, -37}, {-52, -38}, {-38, -38}, {-38, -37.5}, {-31.5, -37.5}}, color = {0, 0, 0}));
      connect(bus2.terminal, T2_i.terminalB) annotation(
        Line(points = {{-31.5, -37.5}, {-22, -37.5}, {-22, -38}, {2, -38}, {2, -32}}, color = {0, 0, 0}));
      connect(L4_2.terminalB, bus4.terminal) annotation(
        Line(points = {{-52, -57}, {-52, -57.5}, {-41.5, -57.5}}, color = {0, 0, 0}));
      connect(bus4.terminal, T4_iX2.terminalB) annotation(
        Line(points = {{-41.5, -57.5}, {-26, -57.5}, {-26, -60}}, color = {0, 0, 0}));
      connect(sc22.terminal, bus22.terminal) annotation(
        Line(points = {{32, 22}, {32.5, 22}, {32.5, 4.5}}, color = {0, 0, 0}));
      connect(bus22.terminal, T22_i.terminalB) annotation(
        Line(points = {{32.5, 4.5}, {36, 4.5}, {36, 4}, {38, 4}, {38, -12}, {30, -12}}, color = {0, 0, 0}));
      connect(T42_iX2.terminalB, bus42.terminal) annotation(
        Line(points = {{6, -84}, {34, -84}, {34, -90}}, color = {0, 0, 0}));
      connect(bus42.terminal, gen42x2.terminal) annotation(
        Line(points = {{34, -90}, {34, -106}}, color = {0, 0, 0}));
      annotation(
        Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}})),
        Diagram(coordinateSystem(extent = {{-160, 80}, {80, -140}}), graphics = {Text(origin = {41, 64}, extent = {{-19, 6}, {19, -6}}, textString = "OK! V. info", textColor = {0, 0, 0})}),
        experiment(StopTime = 6, Interval = 0.00400267, Tolerance = 1e-06, StartTime = 0),
        __OpenModelica_simulationFlags(lv = "LOG_STATS", outputFormat = "mat", s = "dassl"),
        Documentation(info = "<html>
<p>See description of Bus1FaultSI</p>
</html>"));
    end UnregRefbus;
    ...
    package Regulated
      model Bus1FaultSI2OK
        ...
        PowerGridsMC.Electrical.Branches.TransformerFixedRatio T4_iX2(SNom(displayUnit = "MW") = 190e6*2, UNomA(displayUnit = "kV") = 236100, UNomB(displayUnit = "kV") = 236100, X = 0.04828*220^2/100/2, showPortData = false) annotation(
          Placement(visible = true, transformation(origin = {-28, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
        Support.ReferenceBusRnew bus42(SNom(displayUnit = "V.A") = 5e+08, UNom(displayUnit = "V") = 10e3, portVariablesPhases = true, nameShort = "gen42x2", portVariablesPu = true) annotation(
          Placement(visible = true, transformation(origin = {18, -86}, extent = {{-10, 10}, {10, -10}}, rotation = 90)));
        PowerGridsMC.Electrical.Branches.TransformerFixedRatio T41_iX2(SNom(displayUnit = "MW") = 190e6*2, UNomA(displayUnit = "kV") = 236100, UNomB(displayUnit = "kV") = 127900, X = 0.02476*119^2/100/2, rFixed = 127.9/236.1, showPortData = false) annotation(
          Placement(visible = true, transformation(origin = {-28, -96}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        PowerGridsMC.Electrical.Buses.Bus bus3(SNom(displayUnit = "V.A") = 100e6, UNom(displayUnit = "V") = 220e3, portVariablesPhases = true, portVariablesPu = true) annotation(
...
<p>Checked: Bus1, Bus2, Bus31, Bus33.</p>
      ...
      model Bus1FaultSI2bis
        ...
        PowerGridsMC.Electrical.Branches.TransformerFixedRatio T42_iX2(SNom(displayUnit = "MW") = 190*2, UNomA(displayUnit = "V") = 236.1, UNomB(displayUnit = "V") = 15.75, X = 0.017488*14.7^2/100/2, rFixed = 15.75/236.1, showPortData = true) annotation(
      ...
      equation
        ...
        connect(bus42.terminal, bus42_.terminal) annotation(
          Line(points = {{18, -72}, {42, -72}, {42, -71.5}, {42.5, -71.5}}, color = {0, 0, 0}));
        annotation(
...
<p>Il problema &egrave; che i dati iniziali di potenza del generatore non vengono tenuti bloccati ma sono variabili. In questo modo la soluzione del problema iniziale &egrave; indeterminata e le potenze del bus reference possono andare dappertutto.</p>
    ...
    package Support
      model ReferenceBusRnew "With field for PF reading"
        //    PFout[1,1]=port.U;
        ...
        //    PFout[1,6]=port.PPu;
        //    PFout[1,7]=port.QPu;
        extends PowerGridsMC.Electrical.Buses.ReferenceBus(PStart = 0, QStart = 0, UStart = PFout[1, 1], UNom = PFout[1, 1], SNom = PFout[1, 3], UPhaseStart = PFout[1, 2]);
        ...
        parameter String nameShort = "instName" "Instance name of the generator connected to this bus";
        final parameter Real PFout[:, :] = Modelica.Utilities.Streams.readRealMatrix(nameShort + ".mat", "y", 1, 7);
        annotation(
          Icon(graphics = {Rectangle(extent = {{-54, -22}, {-18, -54}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Text(extent = {{48, -16}, {92, -50}}, textColor = {162, 29, 33}, textStyle = {TextStyle.Italic}, textString = "R")}),
          Documentation(info = "<html>
