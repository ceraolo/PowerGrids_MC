...
model TwoGeneratorsOneReferenceGenerator
  ...
  PowerGridsMC.Examples.Tutorial.GridOperation.Controlled.ControlledGenPSS GEN1(GEN(UNom = 21e3, SNom = 500e6, UStart = 20.825e3, UPhaseStart = 9.1746/180*3.14159, PStart = -450.88e6, QStart = -294.351e6), TGOV(R = 0.05)) annotation(
  ...
  PowerGridsMC.Examples.Tutorial.GridOperation.Controlled.ControlledGenPSS GEN2(GEN(UNom = 21e3, SNom = 500e6, UStart = 20.825e3, UPhaseStart = 9.1746/180*3.14159, PStart = -450.88e6, QStart = -294.351e6), TGOV(R = 0.05)) annotation(
  ...
  PowerGridsMC.Electrical.Loads.LoadAlphaBeta GRIDL1(PRef = 450e6 + (if time < 1 then 0 else -100e6), PRefConst = 4.5e+08, QRefConst = 200e6, SNom = 500e6, UNom = 380000, portVariablesPhases = true) annotation(
    Placement(transformation(origin = {-10, 2}, extent = {{-10, -10}, {10, 10}})));
  PowerGridsMC.Electrical.Loads.LoadAlphaBeta GRIDL2(PRefConst = 4.5e+08, QRefConst = 200e6, SNom = 500e6, UNom = 380000, portVariablesPhases = true) annotation(
...
equation
  ...
  connect(GEN2.omega, systemPowerGrids.omegaRefIn) annotation(
    Line(points = {{89, 8}, {94, 8}, {94, 8.2}, {100.2, 8.2}}, color = {0, 0, 127}));
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-100, -20}, {120, 40}}), graphics = {Text(origin = {-22, -15}, extent = {{-20, 3}, {20, -3}}, textString = "Code:
