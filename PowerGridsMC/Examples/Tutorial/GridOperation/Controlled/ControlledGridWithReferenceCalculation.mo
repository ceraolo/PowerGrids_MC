...
model ControlledGridWithReferenceCalculation "System under automatic control with automatic computation of set point offsets"
  ...
  PowerGridsMC.Controls.FreeOffset VrefPu(use_u = true) annotation (
...
equation
  ...
  connect(TGOV.PMechPu, GEN.pmPuIn) annotation (Line(points={{-26,28},{-18,28},
          {-18,4},{-10.4,4},{-10.4,3.4}}, color={0,0,127}));
