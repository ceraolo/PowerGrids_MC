package PowerGridsMC
  ...
  annotation(
    version = "1.1.0",
    uses(Modelica(version = "4.1.0"), Complex(version = "4.1.0")),
...
<p><i>***********************************</i></p>
<p>Copyright &copy; 2018-2020, RTE.</p>
<p>PowerGridsMC is licensed under the terms of the Mozilla Public License, v. 2.0. If a copy of the MPL was not distributed with this file, you can obtain one&nbsp;<a href=\"http://mozilla.org/MPL/2.0.\">here</a>.</p>
<p>-------------------------------------------------------------------------------------------------------------</p>
<p>The PowerGrids library is a library for the modelling of power generation and transmission systems for electro-mechanical phenomena (&quot;phasor&quot; approximation).</p>
