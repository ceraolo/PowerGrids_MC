...
// The simplified model has no saturation, to make the controller equations linear
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, initialScale = 0.1), graphics = {Line(origin = {-12.32, -0.16}, points = {{-12, 0}, {12, 0}}, color = {0, 0, 127}, pattern = LinePattern.Dash), Text(origin = {-32, 46}, extent = {{-68, -4}, {106, 4}}, textString = "I.u = if (G.y >= 0 and lim.u > lim.uMax) 
or 
(G.y <= 0 and lim.u < lim.uMin) then 0 else G.y

(see text view)"), Line(origin = {85, -61}, points = {{75, 25}}), Line(origin = {-4.62687, 9.80597}, points = {{0, 14}, {0, -8}}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Text(origin = {-24, 79}, extent = {{-96, 11}, {16, -3}}, textString = "Integrator charging
 upper limiter engaged"), Text(origin = {78, 79}, extent = {{-94, 11}, {16, -3}}, textString = "Integrator discharging
