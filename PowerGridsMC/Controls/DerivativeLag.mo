...
equation
  ...
  annotation (
    ...
    Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, initialScale = 0.1), graphics = {Text(origin = {-88, 68}, extent = {{-2, 4}, {180, -18}}, textString = "The case noDynamics = true is handled via conditional blocks (see text view)
