...
equation
  ...
  annotation (
    ...
    Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, initialScale = 0.1), graphics = {Text(origin = {-68, 58}, extent = {{-24, 4}, {160, -25}}, textString = "The case noDynamics = true is handled via conditional blocks (see text view)
