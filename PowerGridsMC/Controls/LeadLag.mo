...
equation
  ...
  annotation (
    ...
    Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, initialScale = 0.1), graphics = {Text(origin = {-82, 54}, extent = {{-18, 12}, {182, -8}}, textString = "The case noDynamics = true is handled via conditional blocks (see text view)
