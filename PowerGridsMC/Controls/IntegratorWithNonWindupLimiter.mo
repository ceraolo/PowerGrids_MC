...
// The simplified model has no saturation, to make the controller equations linear
  I.u = homotopy(actual = if (u*k > 0 and lim.u > lim.uMax) or (u*k < 0 and lim.u < lim.uMin) then 0 else u, simplified = u);
  annotation(
    Icon(coordinateSystem( initialScale = 0.1, extent = {{-100, -100}, {100, 100}}), graphics = {Line(origin = {0, 1.05741}, points = {{-80, -121.057}, {-40, -121.057}, {42, 118.943}, {80, 118.943}}), Rectangle(lineColor = {0, 0, 127}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {12, 28}, extent = {{-44, 34}, {26, -16}}, textString = "k"), Text(origin = {2, -30}, extent = {{-60, 22}, {60, -22}}, textString = "s"), Line(origin = {56, 0}, points = {{-86, 0}, {-24, 0}})}),
    Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, initialScale = 0.1), graphics = {Line(origin = {-69, 0}, points = {{-29, 0}, {29, 0}}, color = {0, 0, 127}, pattern = LinePattern.Dash), Text(origin = {-1, 35}, extent = {{-109, 15}, {109, -15}}, textString = "I.u = if (u*k > 0 and lim.u > lim.uMax) 
or 
(u*k < 0 and lim.u < lim.uMin) then 0 else u

(see text view)"), Line(origin = {-68, 11}, points = {{0, 13}, {0, -7}, {0, -9}}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Text(origin = {-71, 74}, extent = {{-17, 8}, {41, -12}}, textString = "Integrator charging
upper limiter engaged"), Text(origin = {21, 74}, extent = {{-17, 8}, {41, -12}}, textString = "Integrator discharging
