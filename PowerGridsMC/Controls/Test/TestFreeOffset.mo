...
model TestFreeOffset
  ...
  PowerGridsMC.Controls.FreeOffset freeOffset1 annotation (
...
<p>Tests for the <a href=\"modelica://PowerGridsMC.Controls.FreeOffset\">PowerGridsMC.Controls.FreeOffset</a> model. The two required additional equations are found in the text view.
</html>"));
end TestFreeOffset;
