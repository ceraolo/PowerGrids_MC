...
model TestLeadLag
  ...
  PowerGridsMC.Controls.LeadLag leadLag(T1 = 4, T2 = 2, initType = Modelica.Blocks.Types.Init.SteadyState, k = 10, yStart = 10) annotation (
    Placement(visible = true, transformation(origin = {-61, 59}, extent = {{-21, -21}, {21, 21}}, rotation = 0)));
  PowerGridsMC.Controls.LeadLag leadLagNoDynamics(T1 = 0, T2 = 0,initType = Modelica.Blocks.Types.Init.SteadyState, k = 10) annotation (
