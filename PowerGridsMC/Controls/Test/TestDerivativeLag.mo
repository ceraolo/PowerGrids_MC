...
model TestDerivativeLag
  ...
  PowerGridsMC.Controls.DerivativeLag derivativeLag(Td = 4, T1 = 2, initType = Modelica.Blocks.Types.Init.SteadyState)  annotation (
    Placement(visible = true, transformation(origin = {-59, 41}, extent = {{-21, -21}, {21, 21}}, rotation = 0)));
  PowerGridsMC.Controls.DerivativeLag derivativeLagNoDynamics(T1 = 0, initType = Modelica.Blocks.Types.Init.SteadyState)  annotation (
