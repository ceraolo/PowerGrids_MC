...
model TestPIWithNonWindupLimiter
  ...
  PowerGridsMC.Controls.PIWithNonWindupLimiter PIController(Ki = 4, Kp = 2, initType = Modelica.Blocks.Types.Init.InitialOutput, yMax = 10)  annotation (
  ...
  PowerGridsMC.Controls.PIWithNonWindupLimiter PIControllerNegativeKp(Ki = -4, Kp = -2, initType = Modelica.Blocks.Types.Init.InitialOutput, yMax = 10) annotation (
    Placement(visible = true, transformation(origin = {-26, -32}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
  PowerGridsMC.Controls.PIWithNonWindupLimiter PController(Kp = 2, initType = Modelica.Blocks.Types.Init.InitialOutput, yMax = 10) annotation (
