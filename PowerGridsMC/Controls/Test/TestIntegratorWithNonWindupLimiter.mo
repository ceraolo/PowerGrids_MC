...
model TestIntegratorWithNonWindupLimiter
  ...
  PowerGridsMC.Controls.IntegratorWithNonWindupLimiter integrator1(
  ...
  PowerGridsMC.Controls.IntegratorWithNonWindupLimiter integrator2(initType = Modelica.Blocks.Types.Init.InitialOutput, k = -2, yMax = 4) annotation (
